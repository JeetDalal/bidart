...
class FollowArtistScreen extends StatefulWidget {
  const FollowArtistScreen({super.key});

  @override
  State<FollowArtistScreen> createState() => _FollowArtistScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            "Follow artists that most interest you",
